...
const Quiz = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState('url(./Assets/bgimglight.png)'); // Replace with your default image
  ...
  const handleHighlight = () => {
    setHighlighted(true);
    setIsColorToggled(true);
  };

  const handleRemoveHighlight = () => {
    setHighlighted(false);
    setIsColorToggled(false);
  };

  const handleChangeBackground = () => {
    setBackgroundImage('url(./assets/bgimgdark.png)');
  };
  ...
  return (
    ...
    <button
      id="button"
      className="ChangeBackground-Btn"
    ...
    >
      ...
      <div className="container" style={{ backgroundImage: backgroundImage }}>
        {showResult ? (
          ...
          <>
            <div className={`question ${highlighted ? 'highlighted' : ''}`} style={{ color: isColorToggled ? 'red' : 'black' }}>
